            ...
            <div className="grid gap-8 mb-6 lg:mb-16 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3">
                <div className="items-center bg-gray-50 rounded-xl shadow w-auto dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <div className="p-5">
                        <h3 className="text-lg font-bold tracking-tight text-gray-900 dark:text-white font-anka-coder">
                            <a href="#">vincent zheng</a>
                        </h3>
                        <span className="text-md text-gray-500 dark:text-gray-400">co-president</span>
                ...
                <div className="items-center bg-gray-50 rounded-xl shadow w-auto h-auto dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <div className="p-5">
                        ...
                        <span className="text-md text-gray-500 dark:text-gray-400">web developer</span>
                    </div>
                </div>
                <div className="items-center bg-gray-50 rounded-xl shadow w-auto h-auto dark:bg-gray-800 dark:border-gray-700">
                    <a href="#">
                    ...
                    <div className="p-5">
                        ...
                        <span className="text-md text-gray-500 dark:text-gray-400">treasurer</span>
                    </div>
                </div>
                <div className="items-center bg-gray-50 rounded-xl shadow w-auto h-auto dark:bg-gray-800 dark:border-gray-700">
                    <a href="#">
                    ...
                    <div className="p-5">
                        <h3 className="text-lg font-bold tracking-tight text-gray-900 dark:text-white font-anka-coder">
                            <a href="#">victoria karai</a>
                        </h3>
                        <span className="text-md text-gray-500 dark:text-gray-400">project manager</span>
                    </div>
                </div>
                <div className="items-center bg-gray-50 rounded-xl shadow w-auto h-auto dark:bg-gray-800 dark:border-gray-700">
                    <a href="#">
                    ...
                    <div className="p-5">
                        ...
                        <span className="text-md text-gray-500 dark:text-gray-400">graphic designer</span>
                    </div>
                </div>
            </div>
